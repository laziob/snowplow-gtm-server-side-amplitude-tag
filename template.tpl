...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Custom Amplitude Tag for timestamp tests",
  "brand": {
  ...
  "description": "This is a custom template that uses the base code of the Snowplow authored Amplitude tag but adds the _time field for passing a custom timestamp that overrides the one Amplitude sets by default.",
  "containerContexts": [
    "SERVER"
  ]
}
...
[
  ...
  },
  {
    ...
    "subParams": [
      ...
      {
        "type": "CHECKBOX",
        "name": "setCustomTimestamp",
        "checkboxText": "Set Custom Timestamp Value",
        "simpleValueType": true,
        "defaultValue": false,
        "help": "This will set a _time field which will override Amplitude\u0027s value of said field."
      },
      {
        "type": "TEXT",
        "name": "customTimestampField",
        "displayName": "Custom Timestamp Field",
        "simpleValueType": true,
        "enablingConditions": [
          {
            "paramName": "setCustomTimestamp",
            "paramValue": true,
            "type": "EQUALS"
          }
        ],
        "help": "Value needs to be in milliseconds since epoch format"
      },
      {
        "type": "GROUP",
        "name": "entityRules",
...
if(data.setCustomTimestamp) {
  amplitudeEvent._time = eventData[data.customTimestampField];
}
...
let authedAmplitudeEvent = {
  api_key: data.apiKey,
  events: [cleanObject(amplitudeEvent)],
};
...
sendHttpRequest(
  ...
  JSON.stringify(authedAmplitudeEvent)
);
...
setup: "const json = require('JSON');\nconst log = require('logToConsole');\n\nconst\
  ...
  :\"a86c42e5-b831-45c8-b706-e214c26b4b3d\",\n  \"x-sp-dvce_created_tstamp\": 1658153115287\n\
